# Assignment 7: Back Propagation Network for XOR function with Binary Input and Output

**Objective:** Train a backpropagation network with **binary inputs and outputs** to learn the XOR function, demonstrating the complete gradient-descent training cycle.
