# Assignment 8: ART (Adaptive Resonance Theory) neural network

**Objective:** Implement the **ART1 (Adaptive Resonance Theory)** algorithm, which performs unsupervised clustering on binary patterns while balancing *plasticity* (learning new patterns) and *stability* (preserving old ones).
